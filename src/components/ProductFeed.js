...
export default function ProductFeed({ allProducts }) {
  ...
  const categories = ['All', ...new Set(allProducts.map(product => product.category_name))];
  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-[108px] z-30 mb-8">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        {hasMore && (
          <div className="mt-12 text-center pb-8">
            ...
            >
              Load More {activeCategory === 'All' ? 'Essentials' : activeCategory} ↓
            </button>
          </div>
        )}
